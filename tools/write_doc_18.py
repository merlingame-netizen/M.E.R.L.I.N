#!/usr/bin/env python3
"""Génère DOC_18_ArbreDeVie_PixelArt.md dans docs/20_card_system/."""
import os

DOC = """# DOC_18 — Arbre de Vie : Pixel Art Procédural
...
out_path = os.path.join(
    os.path.dirname(__file__), "..", "docs", "20_card_system",
    "DOC_18_ArbreDeVie_PixelArt.md"
)
