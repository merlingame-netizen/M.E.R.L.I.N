...
const CATEGORIES = ['ALL', 'DESIGN', 'GRAPHICS', 'GAMEDESIGN', 'RENDERING', 'UX'] as const;
...
export function HumanFeedback() {
  ...
  return (
    <div className="holo-frame feedback-panel">
      <div className="feedback-panel__header">
        <h2 className="section-title">
          DIRECTOR'S INBOX
          {pendingCount > 0 && (
            <span className="feedback-badge">{pendingCount}</span>
          )}
        </h2>
      </div>
