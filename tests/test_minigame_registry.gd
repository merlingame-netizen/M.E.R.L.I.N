...
func test_detect_field_from_combat_keywords() -> bool:
	var field: String = Registry.detect_field("Le guerrier frappe avec son epee", "", [])
	if field != "finesse":
...
func test_detect_field_from_magic_keywords() -> bool:
	var field: String = Registry.detect_field("Il doit resoudre l'enigme des runes", "", [])
	if field != "logique":
...
func test_detect_field_from_social_keywords() -> bool:
	var field: String = Registry.detect_field("Negocier avec le marchand pour convaincre", "", [])
	if field != "bluff":
...
func test_detect_field_from_observation_keywords() -> bool:
	var field: String = Registry.detect_field("Observer les traces et chercher des indices", "", [])
...
func test_detect_field_from_esprit_keywords() -> bool:
	var field: String = Registry.detect_field("Mediter et se concentrer en silence", "", [])
	if field != "esprit":
...
func test_detect_field_from_perception_keywords() -> bool:
	var field: String = Registry.detect_field("Entendre l'echo dans les ombres", "", [])
	if field != "perception":
...
func test_gm_hint_overrides_keywords() -> bool:
	var field: String = Registry.detect_field("Le guerrier frappe avec son epee", "logique", [])
	if field != "logique":
...
func test_invalid_gm_hint_ignored() -> bool:
	var field: String = Registry.detect_field("Mediter en silence", "invalid_field", [])
	if field != "esprit":
...
func test_tag_combat_maps_to_finesse() -> bool:
	var field: String = Registry.detect_field("Some text", "", ["combat"])
	if field != "finesse":
...
func test_tag_mystery_maps_to_logique() -> bool:
	var field: String = Registry.detect_field("Some text", "", ["mystery"])
	if field != "logique":
...
func test_tag_stealth_maps_to_perception() -> bool:
	var field: String = Registry.detect_field("Some text", "", ["stealth"])
	if field != "perception":
...
func test_ogham_bonus_matching_field() -> bool:
	var bonus: int = Registry.get_ogham_bonus("reveal", "observation")
	if bonus != 10:
...
func test_ogham_bonus_non_matching() -> bool:
	var bonus: int = Registry.get_ogham_bonus("reveal", "vigueur")
	if bonus != 0:
...
func test_ogham_bonus_special() -> bool:
	var bonus: int = Registry.get_ogham_bonus("special", "anything")
	if bonus != 5:
