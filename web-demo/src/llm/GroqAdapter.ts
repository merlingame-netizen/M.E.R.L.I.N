...
export class GroqAdapter {
  ...
  async generateCard(biome: string, context: string): Promise<Card | null> {
    const systemPrompt = `Tu es le narrateur d'un jeu de cartes celtique. Tu generes des rencontres narratives.
Reponds UNIQUEMENT en JSON valide avec cette structure exacte:
{
  "narrative": "Description de la scene (40-120 mots, style celtique)",
  "options": [
    {"verb": "observer", "text": "Action 1", "field": "observation", "effects": ["HEAL_LIFE:3"]},
    {"verb": "negocier", "text": "Action 2", "field": "bluff", "effects": ["ADD_REPUTATION:druides:5"]},
    {"verb": "fuir", "text": "Action 3", "field": "vigueur", "effects": ["DAMAGE_LIFE:2"]}
  ]
}
