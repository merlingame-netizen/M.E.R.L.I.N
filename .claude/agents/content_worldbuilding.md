...
3. Cosmological elements (factions, Rune-Circuits, magic system) need grounding
...
- Cosmology: how magic works, what Rune-Circuits represent, faction origins
...
- Cosmology: Rune-Circuit magic system rules, faction mythological origins
...
5. **Check** Rune-Circuit lore consistency with tree alphabet tradition
...
## Key References
- `docs/GAME_DESIGN_BIBLE.md` — World definition (v3.0)
