...
- **Bible** : `docs/BIBLE.md` v3.0 (source de verite)
...
2. **Bible compliance** : coherence avec BIBLE.md
...
- **Pas de reference morte** : aucune mention Ogham/Triade/Souffle/Bestiole/web-demo dans le code actif
