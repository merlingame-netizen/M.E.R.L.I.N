...
const TRINITY_MODELS := {
	"Q4_K_M": {"file": "Trinity-Nano-Preview-Q4_K_M.gguf", "size_mb": 1800, "desc": "Fast, good quality"},
	"Q5_K_M": {"file": "Trinity-Nano-Preview-Q5_K_M.gguf", "size_mb": 2100, "desc": "Balanced"},
	"Q8_0": {"file": "Trinity-Nano-Preview-Q8_0.gguf", "size_mb": 3200, "desc": "Best quality"},
}
