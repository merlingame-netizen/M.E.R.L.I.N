...
const ACT3_DEZOOM_S: float = 3.4    # dézoom + apparition du décor (saison + heure)  # 08/09 : le décor se CONSTRUIT (lune en goutte, collines qui se lèvent, arbres qui poussent) — il faut le temps de le voir
