...
static func _procedural_synopsis(biome_id: String, biome_name: String,
	...
	var backstories: Dictionary = {
		...
		"landes_bruyere": [
			...
			"Depuis l'equinoxe, la bruyere de %s pousse dans des motifs que personne ne comprend. Vus du ciel, les lignes forment des runes. Le message est incomplet, mais les deux premiers mots sont clairs : 'Viens maintenant'. Les druides tremblent, car les landes n'avaient pas parle depuis six generations.",
		],
		"cotes_sauvages": [
			"La mer a rejete quelque chose sur les rivages de %s : un coffre de bois noir, incruste de runes, impossible a ouvrir. Les pecheurs qui l'ont touche rapportent des visions — un sentier lumineux sous les vagues, une voix ancienne qui appelle. Le coffre pulse doucement, comme un coeur qui bat. Il faut suivre la piste avant que la maree ne l'emporte a nouveau.",
		],
		"villages_celtes": [
