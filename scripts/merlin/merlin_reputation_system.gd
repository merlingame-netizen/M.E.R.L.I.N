...
## Retourne un dict factions initialisé à FACTION_SCORE_START (20) pour les 5 factions canoniques.
## Bible v2.4: 20 = Neutre. 0 = Hostile (provoque penalties indésirables au premier run).
