...
const VALUE_START: float = 20.0        # Neutral tier start (bible v2.4)
...
## Réinitialise toutes les réputations à VALUE_START (Neutre).
func reset() -> void:
...
## Retourne un dict factions initialisé à VALUE_START (20 = Neutre) pour les 5 factions.
