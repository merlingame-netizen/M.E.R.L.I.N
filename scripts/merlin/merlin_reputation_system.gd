...
## Réinitialise toutes les réputations au score de depart (FACTION_SCORE_START).
func reset() -> void:
...
## Retourne un dict factions au score de depart (FACTION_SCORE_START) pour les 5 factions.
