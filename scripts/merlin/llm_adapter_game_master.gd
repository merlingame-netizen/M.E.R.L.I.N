...
func calculate_smart_effects(context: Dictionary, scenario_text: String, labels: Array[String], merlin_ai: Node) -> Array:
	...
	system += "Ex3 fin: {\"effects\":[[{\"type\":\"PROGRESS_MISSION\",\"step\":1},{\"type\":\"ADD_REPUTATION\",\"faction\":\"niamh\",\"amount\":15}],[{\"type\":\"ADD_REPUTATION\",\"faction\":\"druides\",\"amount\":18},{\"type\":\"HEAL_LIFE\",\"amount\":6}],[{\"type\":\"ADD_REPUTATION\",\"faction\":\"ankou\",\"amount\":-12},{\"type\":\"DAMAGE_LIFE\",\"amount\":8}]]}"
	...
	for option_effects in effects_raw:
		...
		for eff in option_effects:
			...
			if eff_type == "ADD_REPUTATION":
				...
				validated.append({"type": "PROGRESS_MISSION", "step": clampi(int(eff.get("step", 1)), 1, 3)})
