...
func calculate_smart_effects(context: Dictionary, scenario_text: String, labels: Array[String], merlin_ai: Node) -> Array:
	...
	system += "Ex3 fin-de-quete: {\"effects\":[[{\"type\":\"PROGRESS_MISSION\",\"amount\":1},{\"type\":\"ADD_REPUTATION\",\"faction\":\"niamh\",\"amount\":15}],[{\"type\":\"ADD_REPUTATION\",\"faction\":\"druides\",\"amount\":20},{\"type\":\"ADD_REPUTATION\",\"faction\":\"ankou\",\"amount\":-15}],[{\"type\":\"DAMAGE_LIFE\",\"amount\":12},{\"type\":\"ADD_ANAM\",\"amount\":5}]]}"
