#!/usr/bin/env bash
# cmd-002 (pont OCI) — identique a cmd-001 : export des decisions du Studio.
# Rejoue apres correction du diagnostic d'authentification (cmd-001 : auth OCI en echec, motif
# masque par >/dev/null ; le workflow verifie desormais la forme de chaque secret et affiche le
# message d'Oracle en clair).
set -u
