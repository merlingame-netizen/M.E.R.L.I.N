...
Purpose
- Install and set up the Godot MCP integration for Claude.

Scope
- Covers addon install, MCP server setup, and Claude connection.
...
## Usage
See docs/00_overview/command-reference.md for supported commands.
